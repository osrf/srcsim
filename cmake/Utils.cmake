...
#################################################
macro (srcsim_add_library _name)
...
#################################################
macro (srcsim_add_static_library _name)
  add_library(${_name} STATIC ${ARGN})
  target_link_libraries (${_name} ${general_libraries})
endmacro ()

#################################################
macro (srcsim_add_executable _name)
...
#################################################
macro (srcsim_install_includes _subdir)
  install(FILES ${ARGN}
    DESTINATION ${INCLUDE_INSTALL_DIR}/${_subdir} COMPONENT headers)
endmacro()

#################################################
macro (srcsim_install_library _name _exportName)
...
#################################################
macro (srcsim_install_executable _name )
...
macro (srcsim_setup_unix)
  ...
  # Will use predefined developers cflags
