 ...
 *
*/
#ifndef SRC_HARNESSPLUGIN_HH_
#define SRC_HARNESSPLUGIN_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE SRCHarnessPlugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: SRCHarnessPlugin();

    /// \brief Destructor.
    public: virtual ~SRCHarnessPlugin();
    ...
    private: std::unique_ptr<SRCHarnessPluginPrivate> dataPtr;
  };
}
#endif
